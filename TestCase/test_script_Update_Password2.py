# -*- coding:utf-8 -*-
# Author : 彭垚
# TestCase: 个人中心-修改密码-验证码&密码不输入-提交
# DateTime: 2018-03-05
...
class test_script(unittest.TestCase):
    ...
    def test_script(self):
        ...
        # 点击“确定”button
        confirm_button = self.driver.find_element_by_id("tech.yunjing.biconlife.app.mine:id/tv_asomlp_confine")
        confirm_button.click()
        sleep(4)
        # 断言
        fourName = self.driver.find_element_by_name("获取验证码")
        fiveName = self.driver.find_element_by_name("新密码")
        sixName = self.driver.find_element_by_name("确定")
